...
generate_targets <- function(lake_directory, config_set_name, server_name_sc){
    library(tidyverse)
    library(lubridate)
    ...
    generate_in_lake_targets(config_obs, sensorcode_df, server_name_sc)

    # Inflow Targets
    print('Generating Inflow Targets')
    generate_inflow_targets(config_obs, sensorcode_df, server_name_sc)

    # Met Targets
    print('Generating Met Targets')
    generate_met_targets(config_obs, sensorcode_df, server_name_sc)
}
