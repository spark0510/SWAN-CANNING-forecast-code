forecast_workflow <- function(){
  ...
  FaaSr::faasr_get_file(remote_folder="configuration/default", 
                        remote_file="configure_flare.yml", 
                        local_folder="configuration/default", 
                        local_file="configure_flare.yml")

  FaaSr::faasr_get_file(remote_folder="configuration/default", 
                        remote_file="sensorcode.csv", 
                        local_folder="configuration/default", 
                        local_file="sensorcode.csv")
  ...
  # Read in the targets
  server_name_sc <- "SC_S3_Bucket"
  generate_targets(lake_directory, config_set_name, server_name_sc)
